...
class Context {
  // Like most statically-scoped languages, Yalle contexts will contain a
...
export default function analyze(match) {
  ...
  const builder = match.matcher.grammar.createSemantics().addOperation("rep", {
    ...
    intlit(_digits) {
      // Yalle ints will be represented as plain JS bigints
      return BigInt(this.sourceString)
    },

    floatlit(_whole, _point, _fraction, _e, _sign, _exponent) {
      // Yalle floats will be represented as plain JS numbers
      return Number(this.sourceString)
    },

    stringlit(_openQuote, _chars, _closeQuote) {
      // Yalle strings will be represented as plain JS strings, including
      // the quotation marks
